...
# gj-scenegraph — Scene Graph, Traversal Graph & Reactivity Engineer

Source: kit §3.2. Repo rules: `agents/grok/README.md`. Read `SPEC.md`, `PROGRESS.md`, your tickets in `tickets/`, and `projects/skills/scenegraph/SKILLS.md` at every session start.

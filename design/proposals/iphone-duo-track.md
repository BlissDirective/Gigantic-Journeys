...
| 3 | **Rear-camera avatar capture with Duo Preview.** In tent mode on a table, the 48 MP rear cameras photograph the player while the outer display shows framing and coaching; the three face angles and the full-body shot come from the best cameras. | Better likeness for the M2 blind-test target; hands-free capture. | Low | Duo Preview behavior in Unity or a native plugin |

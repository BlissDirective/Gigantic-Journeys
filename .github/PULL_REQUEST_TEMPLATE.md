...
<!-- One row per acceptance test in the ticket, in order. Evidence is a CI job link, a test
name in this PR, a screenshot path in this PR, or a report path in this PR. "Not verified"
needs a reason and means changes-requested. -->

| AT | How verified | Evidence |
|---|---|---|
| AT-1 |  |  |
| AT-2 |  |  |
...
<!-- Required for anything under unity/Assets/UI, unity/Assets/Gameplay, unity/Assets/Player,
...
<!-- Gameplay, UI, capture, avatar, and services PRs: the numbers that apply. Frame time p50 and
...
- [ ] `gj-qa-release` visual pass requested (gameplay, UI, capture PRs)
- [ ] Pre-PR design checklist run (Design Skills §4) for UI and gameplay PRs
